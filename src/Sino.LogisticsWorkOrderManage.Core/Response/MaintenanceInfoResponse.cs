...
namespace Sino.LogisticsWorkOrderManage.Core
{
    ...
    public class MaintenanceInfoResponse
    {
        ...
        /// 工单类型
        /// </summary>
        public string MaintenancTypeName { get; set; }
        ...
        /// 工单状态名称
        /// </summary>
        public string MaintenancStatusName { get; set; }
        ...
        /// 机器类型名称
        /// </summary>
        public string AgriculturalTypeName { get; set; }
        ...
        public string AgriculturalBrandName { get; set; }
